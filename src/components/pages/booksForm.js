...
import {Well, Panel, Row, Col, Image, InputGroup, DropdownButton, MenuItem, FormControl, FormGroup, ControlLabel, Button} from 'react-bootstrap';
...
class BooksForm extends React.Component{
  ...
  //set state cos we are out of global state
  componentDidMount(){
  this.props.getBooks (); 
  ...
  render(){
    ...
    <Well>
      <Row>
        <Col xs={12} sm={6} style={{marginTop:100}}>
           <Panel>
             <InputGroup>
